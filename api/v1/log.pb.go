...
const (
	RequestType_Append RequestType = 0
)
...
const file_api_v1_log_proto_rawDesc = "" +
	...
	"\x05servers\x18\x01 \x03(\v2\x0e.log.v1.ServerR\x05servers"P\n" +
	"\x06Server\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x19\n" +
	"\x08rpc_addr\x18\x02 \x01(\tR\x08rpcAddr\x12\x1b\n" +
	"\tis_leader\x18\x03 \x01(\bR\x08isLeader*\x19\n" +
	"\x0bRequestType\x12\n" +
	"\n" +
	"\x06Append\x10\x002\xd6\x02\n" +
	"\x03Log\x12<\n" +
	"\x07Produce\x12\x16.log.v1.ProduceRequest\x1a\x17.log.v1.ProduceResponse"\x00\x12<\n" +
	"\x07Consume\x12\x16.log.v1.ConsumeRequest\x1a\x17.log.v1.ConsumeResponse"\x00\x12D\n" +
	...
	"\n" +
	"GetServers\x12\x19.log.v1.GetServersRequest\x1a\x1a.log.v1.GetServersResponse"\x00B$Z"github.com/adotkaya/proglog/api/v1b\x06proto3"
...
var file_api_v1_log_proto_goTypes = []any{
	(RequestType)(0),           // 0: log.v1.RequestType
	(*Record)(nil),             // 1: log.v1.Record
	...
	(*Server)(nil),             // 8: log.v1.Server
}
var file_api_v1_log_proto_depIdxs = []int32{
	1, // 0: log.v1.ProduceRequest.record:type_name -> log.v1.Record
	1, // 1: log.v1.ConsumeResponse.record:type_name -> log.v1.Record
	8, // 2: log.v1.GetServersResponse.servers:type_name -> log.v1.Server
